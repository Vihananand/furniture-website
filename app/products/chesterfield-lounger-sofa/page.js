...
export default function ChesterfieldSofaPage() {
  // Generate array of image paths for Chesterfield collection
  const images = Array.from({ length: 7 }, (_, i) => `/images/sofa${i + 1}.jpg`);
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
            Our luxurious Chesterfield collection combines timeless elegance with unparalleled comfort, featuring meticulous craftsmanship and premium materials.
          </p>
          ...
          {images.map((image, index) => (
            <div key={index} className="group">
              ...
              >
                <Image
                  src={image}
                  alt={`Chesterfield Lounger Sofa Design ${index + 1}`}
                  fill
      ...
      <section className="container mx-auto px-6 mt-20">
        <div className="max-w-4xl mx-auto text-center bg-[#F5F2EF] rounded-xl p-10">
          <h2 className="font-cormorant text-3xl md:text-4xl font-semibold mb-6 text-gray-800">
            Want a Custom Chesterfield Design?
          </h2>
          <p className="text-gray-600 mb-8">
            We can create a custom Chesterfield sofa tailored to your specific dimensions, materials, and style preferences.
          </p>
          <Link
            href="/custom-order"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center p-4" onClick={closeImagePreview}>
          <div className="relative max-w-4xl max-h-[90vh] w-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="relative w-full h-[80vh]">
              <Image
                src={selectedImage}
                alt="Chesterfield Lounger Sofa Preview"
                fill
