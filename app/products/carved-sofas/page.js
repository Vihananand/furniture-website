...
export default function CarvedSofasPage() {
  // Generate array of image paths for Carved Sofas collection
  const images = Array.from({ length: 28 }, (_, i) => `/images/carvedsofa${i + 1}.jpg`);
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
            Discover our exquisite collection of meticulously hand-carved sofas, showcasing intricate designs and exceptional artisanship.
          </p>
          ...
          {images.map((image, index) => (
            <div key={index} className="group">
              ...
              >
                <Image
                  src={image}
                  alt={`Carved Sofa Design ${index + 1}`}
                  fill
      ...
      <section className="container mx-auto px-6 mt-20">
        <div className="max-w-4xl mx-auto text-center bg-[#F5F2EF] rounded-xl p-10">
          <h2 className="font-cormorant text-3xl md:text-4xl font-semibold mb-6 text-gray-800">
            Looking for a Custom Carved Design?
          </h2>
          <p className="text-gray-600 mb-8">
            Our master craftsmen can create a bespoke carved sofa with custom carving patterns, dimensions, and finishes to match your vision.
          </p>
          <Link
            href="/custom-order"
